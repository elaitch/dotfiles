...
/* appearance */
char statusbgcolor[MAX_SETTING_SIZE]    = "#66AAAA";            /* background color for status bar */
char statuscolor[MAX_SETTING_SIZE]      = "#222222";            /* color for status bar */
char sslbgcolor[MAX_SETTING_SIZE]       = "#66AAAA";            /* background color for status bar with SSL url */
char sslinvalidbgcolor[MAX_SETTING_SIZE]= "#66AAAA";            /* background color for status bar with unverified SSL url */
char sslcolor[MAX_SETTING_SIZE]         = "#222222";            /* color for status bar with SSL url */


                                        /*  normal,             warning,           error       */
char urlboxfont[][MAX_SETTING_SIZE]     = { "Termsyn 14",   "Termsyn 14",   "Termsyn 14"};
static const char *urlboxcolor[]        = { "#f2f2f2",                   "#ff0000",              "#ffffff" };
static const char *urlboxbgcolor[]      = { "#222222",                   "#222222",                   "#222222" };

                                        /*  normal,                          error               */
char completionfont[2][MAX_SETTING_SIZE] = { "Termsyn 14",   "Termsyn 14" };
                                                                                        /* topborder color */
static const char *completioncolor[]    = { "#f2f2f2",          "#f2f2f2",              "#222222" };
                                                                                        /* current row background */
static const char *completionbgcolor[]  = { "#222222",          "#222222",              "#444444", };
...
static Searchengine searchengines[] = {
    ...
    { "gis",        "https://www.google.ca/search?safe=off&site=&tbm=isch&source=hp&biw=852&bih=714&q=%s&oq=%s&gs_l=img.12..0l10.1438.1677.0.3023.4.4.0.0.0.0.198.603.0j4.4.0....0.0..1ac.1.20.img.TFd_mqIb1IU" },
